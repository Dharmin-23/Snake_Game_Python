...
def new_snake(position_of_pixel, body_list):
    for part in body_list:
        pygame.draw.rect(dis, yellow, [part[0], part[1], position_of_pixel, position_of_pixel])
...
def instructions():
    ...
    while instruction:
        ...
        text = "1: Obstacles are fixed objects and are diplayed by blocks RED in color.\n" \
               ...
               "3: Eating the food(represented by YELLOW) will result in increase in length of the snake by unity.\n" \
               "4: While eating the poison(represented by BLUE) will result in decrease in length by unity.\n" \
               "5: Each time the speed of the snake(Magenta in color) will increase.\n" \
...
# greater than or equal to 3 units.
    ...
    while not game_finishes:
        ...
        pygame.draw.rect(dis, orange, [food_on_x, food_on_y, position_of_snake, position_of_snake])
